...
public class LoginController {
    ...
    public String index(HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            if ((boolean) session.getAttribute(Constants.IS_LOGIN) && session.getAttribute(Constants.MEMBER_DTO) != null) { // 로그인 되어있으면
    ...
    public String login(MemberDTO dto, Model model, HttpServletRequest request) throws NoSuchAlgorithmException {
        ...
        if(memberDTO != null) {
            ...
            // 중복로그인 체크
            SessionConfig.getSessionidCheck(Constants.MEMBER_DTO, dto.getId());

            session.setAttribute(Constants.MEMBER_DTO, memberDTO);
            session.setAttribute(Constants.MEMBER_ID, memberDTO.getId());
    ...
    public String myPage(HttpServletRequest request, Model model) {
        ...
        try {
            if ((boolean) session.getAttribute(Constants.IS_LOGIN) && session.getAttribute(Constants.MEMBER_DTO) != null) {
                model.addAttribute("memberInfo", session.getAttribute(Constants.MEMBER_DTO));
...
//        }
    ...
    public String myInfoUpdateForm(Model model, HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            System.out.println(session.getAttribute(Constants.IS_LOGIN));
    ...
    public String delete(Model model, MemberDTO dto, HttpServletRequest request) throws IOException, NoSuchAlgorithmException {
        ...
        try {
            if (session.getAttribute(Constants.MEMBER_DTO) != null) {
                MemberDTO sessionDto = (MemberDTO) session.getAttribute(Constants.MEMBER_DTO);
